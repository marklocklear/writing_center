...
class InstructorsControllerTest < ActionController::TestCase
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post :create, instructor: { department: @instructor.department, first_name: @instructor.first_name, last_name: @instructor.last_name, phone: @instructor.phone }
    end
  ...
  test "should update instructor" do
    patch :update, id: @instructor, instructor: { department: @instructor.department, first_name: @instructor.first_name, last_name: @instructor.last_name, phone: @instructor.phone }
    assert_redirected_to instructor_path(assigns(:instructor))
  end
