...
class TutorsControllerTest < ActionController::TestCase
  ...
  test "should create tutor" do
    assert_difference('Tutor.count') do
      post :create, tutor: { first_name: @tutor.first_name, info: @tutor.info, last_name: @tutor.last_name, phone: @tutor.phone }
    end
  ...
  test "should update tutor" do
    patch :update, id: @tutor, tutor: { first_name: @tutor.first_name, info: @tutor.info, last_name: @tutor.last_name, phone: @tutor.phone }
    assert_redirected_to tutor_path(assigns(:tutor))
  end
